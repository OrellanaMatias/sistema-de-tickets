                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <select name="tasktype" class="form-control select" required>
                                                ...
                                                <option>Fallo a nivel de hardware</option>
                                                <option>Fallo a nivel de software</option>
                                                <option>Fallo a nivel de red</option>
                                                <option>Fallo a nivel de servidor</option>
                                                <option>Otro fallo</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <select name="priority" class="form-control select">
                                                <option value="">Seleccionar</option>
                                                <option value="Urgente">Urgente(Situación de vida o muerte)</option>
