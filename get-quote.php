                                            ...
                                            ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="check">
                                                                <input type="checkbox" class="icheckbox" name="services[]" value="Recuperación de Información"> Ticket de Wi-Fi</label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        <label class="check">
                                                            <input type="checkbox" class="icheckbox" name="services[]" value=" Formateo de Dispositivo"> Notebooks</label>
                                                    </div>
