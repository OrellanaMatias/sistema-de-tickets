...
if (isset($_POST['submit'])) {
    ...
    $query = $_POST['query'];
    $pd = date('Y-m-d');
    mysqli_query($con, "insert into prequest(name,email,contacto,curso,services,others,query,posting_date) values('$name','$email','$contact','$curso','$services','$other','$query','$pd')");
...
<head>
    ...
    <meta content="Orellana Matias" name="author" />
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <p>Por favor, rellene los campos de abajo según el servicio que desea solicitar:</p>
                                </div>
                                <div class="panel-body bg-white">
                                    ...
                                    <div class="row">
                                            ...
                                            ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="check">
                                                                <input type="checkbox" class="icheckbox" name="services[]" value="Ticket Wi-Fi"> Ticket Wi-Fi</label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 text-left text-left control-label">Curso</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="curso" class="form-control datepicker" value="" required>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        <label class="check">
                                                            <input type="checkbox" class="icheckbox" name="services[]" value=" Notebooks"> Notebooks</label>
                                                    </div>
