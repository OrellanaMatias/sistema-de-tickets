...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
    <div class="container">
      <a class="navbar-brand" href="https://https://github.com/OrellanaMatias">Orellana Matias</a>
  ...
  <footer class="py-5">
    <div class="container">
      <p class="m-0 text-center text-black">Sistema de Generación de Tickets</p>
    </div>
    <!-- /.container -->
  </footer>
